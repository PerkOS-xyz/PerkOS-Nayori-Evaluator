...
The evaluator is initially restricted to Stacks testnet. Its LLM adapter receives evidence and
criteria only; it never receives signer material. The chain adapter exposes only
